         ...
         <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div >
                        <div class="white-box">
                            <form method="POST" class="form-horizontal form-material" action="<?= base_url('Admin/add') ?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-md-12">Tittle</label>
                                    <div class="col-md-12">
                                        <input type="text" name="tittle" placeholder="your product tittle" class="form-control form-control-line"> </div>
                                    </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Basic Description</label>
                                    <div class="col-md-12">
                                        <input type="text" name="basic" placeholder="Short description" class="form-control form-control-line" > </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="price" placeholder="123 456 7890" class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Discount</label>
                                    <div class="col-md-12">
                                        <input type="text" name="discount" placeholder="123 456 7890" class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">quantity</label>
                                    <div class="col-md-12">
                                        <input type="text" name="quantity" placeholder="123 456 7890" class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group ">
                                <div class="col-md-12">
                                ...
                                if (isset($_POST['image']) && $_POST['image'] != null) {
                                    ...
                                    <?php if (isset($_GET['to_lang'])) { ?>
                                        <input type="hidden" name="image" required value="<?= $_POST['image'] ?>">
                                        <?php
                                    }
                                }
                                ?>
