        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?= base_url('Admin/publish') ?>" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i>Publish</a>
                    </li>
                    <li>
                        <a href="<?= base_url('Admin/Basic') ?>" class="waves-effect"><i class="fa fa-table fa-fw" aria-hidden="true"></i>Basic Table</a>
                    </li>
                    <li>
