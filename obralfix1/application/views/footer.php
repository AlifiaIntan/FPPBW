			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<div class="p-t-27">
						...
						<a href="https://www.instagram.com/obral_aja/?hl=id" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('.add_cart_one_item').click(function(){
			var for_id    = $(this).data("produkid");
			var title  = $(this).data("produknama");
			var price = $(this).data("produkharga");
			var quantity     = 1;
	...
	function populateCartContents() {
		$.ajax({
				url : "<?php echo base_url();?>cart/show_cart_sidebar/",
				method : "GET",
